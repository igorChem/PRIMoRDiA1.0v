...
Imolecule QMparser::get_molecule(){
	...
	if ( program == "mopac" ){
		...
		if ( file_obj.is_open ){
			...
			m_log->input_message("File file not open! Ending without succes the parsing process!");
		...
		if ( file_obj.is_open ){
			...
			m_log->input_message("File not open! Ending without succes the parsing process!");
			return empty_molecule;
		}
		...
		m_log->input_message("Parsing process end without valid molecular information stored!");
		return empty_molecule;
	}
}
/**********************************************************************************/
